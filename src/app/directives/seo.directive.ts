...
export class SeoDirective implements OnInit {
   ...
   constructor(@Inject(DOCUMENT) private document: Document, private meta: Meta, private router: Router, private renderer: Renderer2) {}
   ...
   private updateCanonicalLink(): void {
      ...
      const href = `https://gcwiley.github.io/demo-angular-material-rxdb${window.location.pathname}`;
